...
$string['confirmbulkediteenrolment'] = 'Estás seguro de que quieres cambiar estas inscripciones?';
$string['customwelcome'] = 'Mensaje personalizado de bienvenida';
$string['customwelcome_help'] = 'Un mensaje personalizado de bienvenida puede ser agregado como texto plano o formato de Moodle, incluyendo etiquetas HTML y multi-lenguaje .
...
* Nombre de curso completado {$a->completed}
* Enlace a la página de perfil de usuario {$a->profileurl}
* Correo de usuario {$a->email}
* Nombre completo {$a->fullname}';
$string['deleteselectedusers'] = 'Borrar matriculaciones seleccionadas en completación del curso';
$string['editselectedusers'] = 'Editar matriculaciones seleccionadas en completación del curso';
...
$string['welcome_help'] = 'Cuando un usuario esta inscrito en un curso por terminar otro curso, se envía un mensaje de bienvenida por correo.';
