...
/**
 * Unit tests for the enrolment on course completion.
 *
...
// Class extends phpunit_coverage_info.
return new class extends phpunit_coverage_info {
    ...
    protected $excludelistfiles = ['version.php', 'manage.php', 'settings.php', 'tests/coverage.php'];
};
